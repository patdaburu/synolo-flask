...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'synolo_flask' / "version.py")
)
...
setup(
    name='synolo_flask',
    description="This is the synolo Flask REST API!",
    ...
    entry_points="""
    [console_scripts]
    synolo-flask=synolo_flask.cli:cli
    """,
    ...
    url='https://github.com/patdaburu/synolo_flask',
    download_url=(
        f'https://github.com/patdaburu/'
        f'synolo_flask/archive/{version}.tar.gz'
    ),
    keywords=[
